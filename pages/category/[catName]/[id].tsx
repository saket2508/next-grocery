            ...
            {cartLoading || authLoading
                ...
                : (<main className="max-w-full">
                    ...
                    <div className="bg-white border border-gray-300 px-6 py-2">
                        {product.discount && <div className="sm:hidden my-2 w-16">
                        ...
                        <div className="flex flex-col items-center md:items-start md:flex-row md:justify-center">
                            <img src={product.img_lg} className="object-fit h-48 w-48 md:h-96 md:w-96 md:pb-10 md:pr-10"/>
                            <div className="flex flex-col items-center md:items-start lg:pl-10 md:pt-10">
                                {product.discount && <div className="hidden sm:block my-2 w-16">
                                    <div className="p-1 flex items-center justify-center bg-green-600 text-white text-xs uppercase rounded-md font-bold">
                                        {product.discount}% Off
                                    </div>
                                </div>}
                                ...
                                <div className="hidden sm:block pt-4 flex flex-col text-sm font-medium sm:text-base">
                                    {product.price_before_discount && <div className="flex flex-row justify-start pb-1 text-gray-600 text-sm">
                                        MRP:
                                    ...
                                    {product.price_before_discount && <div className="flex flex-row justify-start pb-2 text-gray-600 text-sm pt-1">
                                        You Save:
                                ...
                                <div className="sm:hidden flex flex-row items-end font-medium py-2">
                                    ...
                                    {product.price_before_discount && <div className="line-through text-gray-800 pl-3 text-sm">
                                            ₹{product.price_before_discount}
                                    </div>}
                                </div>
                                {product.price_before_discount && <div className="sm:hidden text-gray-600 text-sm flex flex-row">
                                    You save: <div className="pl-2 text-yellow-600 font-medium">₹{getPriceDifference(product)}</div>
                                </div>}
                                <div className="pt-5">
