...
const Cart: NextPage = () => {
    ...
    let cartData = cart?.map((item: Order) => ({...products[parseInt(item.product_id) - 1], items: item.qty }))
    let totalAmt = 0
    if(cartData){
                    ...
                    :  !cart || cart.length === 0
                        ...
                        : (<div className='pb-10'>
                            <div className='pt-6'>
                                ...
                                <h3 className="text-lg sm:text-2xl pt-6 pb-2 font-semibold">Your Bag</h3>
